...
| Phương Thức   |  VCI  |  KBS  | CAFEF | Ghi Chú                                                    |
| ------------- | :---: | :---: | :---: | ---------------------------------------------------------- |
...
| news          |   ✅   |   ✅   |   ✅   | Tin tức công ty (hỗ trợ `mode='detail'` cho toàn bộ nguồn) |
| reports       |   ✅   |   ❌   |   ❌   | Báo cáo phân tích từ các công ty chứng khoán               |
| trading_stats |   ✅   |   ❌   |   ❌   | Thống kê giao dịch tổng hợp                                |
| ratio_summary |   ✅   |   ❌   |   ❌   | Tóm tắt chỉ số tài chính                                   |

**Khuyến Nghị**: VCI và KBS là 2 nguồn dữ liệu toàn diện nhất cho hồ sơ doanh nghiệp. CafeF và KBS rất mạnh về tốc độ cập nhật tin tức (`news`). Tùy nhu cầu để sử dụng tham số `mode='detail'` trích xuất nội dung chi tiết.
