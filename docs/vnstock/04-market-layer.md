...
> [!NOTE]
> Các phương thức trong domain Market được thiết kế để tối ưu hóa việc lấy dữ liệu hàng loạt. Nếu bạn cần dữ liệu với tần suất cực cao cho mục đích giao dịch thuật toán (Algo Trading), vui lòng tham khảo các hạng thành viên Tài trợ (Sponsor) tại tài liệu **So sánh Miễn phí vs Tài trợ**.
